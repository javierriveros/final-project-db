 ...
 */
public class NewTeacherGroup extends javax.swing.JFrame {
  private javax.swing.JFrame parent;
  private Conforms conforms;
  private Group group;
   ...
   * @param parent
   */
  public NewTeacherGroup(javax.swing.JFrame parent, Group group) {
    this.parent = parent;
    this.group = group;
    initComponents();
    addAttributes();
  ...
  private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
    ...
    this.conforms = new Conforms(teacherId, this.group.getId());
    try {
      if (this.conforms.save()) Util.showWarning(this, "Datos guardados");
